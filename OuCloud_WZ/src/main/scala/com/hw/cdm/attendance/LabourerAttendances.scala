package main.scala.com.hw.cdm.attendance
  ...
  def main(args: Array[String]): Unit = {
    ...
    val sql =
      """
        ...
        | row_number() over( partition by IFNULL(W1.pid,W2.pid) order by ifnull(W1.record_time,W1.record_time) DESC ) rank
        |FROM
